  ...
  test "can read adjustments" do
    ...
    expected_entries = [
      %NewWay.Schema.Adjustment{
        id: 1,
        event_created_at: ~N[2004-10-19 10:23:54],
        domain_revision: 1,
        ...
        created_at: ~N[2004-10-19 10:23:54],
        status: :captured,
        status_captured_at: ~N[2004-10-19 10:23:54],
        status_cancelled_at: ~N[2004-10-19 10:23:54],
        reason: "test_reason_1",
        wtime: ~N[2004-10-19 10:23:54],
        current: true,
        fee: 10,
        provider_fee: 10,
        external_fee: 10,
  ...
  test "can read destinations" do
    ...
    expected_entries = [
      %NewWay.Schema.Destination{
        ...
        event_id: 1,
        event_created_at: ~N[2004-10-19 10:23:54],
        event_occured_at: ~N[2004-10-19 10:23:54],
        sequence_id: 1,
  ...
  test "can read wallets" do
    ...
    expected_entries = [
      %NewWay.Schema.Wallet{
        id: 1,
        event_id: 1,
        event_created_at: ~N[2004-10-19 10:23:54Z],
        event_occured_at: ~N[2004-10-19 10:23:54Z],
        sequence_id: 1,
  ...
  test "can read withdrawals" do
    ...
    expected_entries = [
      %NewWay.Schema.Withdrawal{
        ...
        provider_id: "test_provider_id_1",
        amount: 1000,
        currency_code: "RUB",
